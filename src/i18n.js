export const managedLocaleMessages = {
  ko: {
    ...
    cameraAuto: '자동',
    cameraAutoTitle: '마우스로 돌린 뒤 손을 떼면 현재 차원 시점으로 돌아가기',
    cameraAutoOffTitle: '자동 시점 복귀 끄기',
    locked: '고정됨',
    lock: '고정',
  ...
  en: {
    ...
    cameraAuto: 'Auto',
    cameraAutoTitle: 'Return to the current dimension view after dragging',
    cameraAutoOffTitle: 'Turn off automatic view return',
    locked: 'Locked',
    lock: 'Lock',
  ...
  ja: {
    ...
    cameraAuto: '自動',
    cameraAutoTitle: 'ドラッグ後に現在の次元の視点へ戻す',
    cameraAutoOffTitle: '視点の自動復帰をオフ',
    locked: '固定中',
    lock: '固定',
    graphControls: 'グラフ操作',
  ...
  zh: {
    ...
    cameraAuto: '自动',
    cameraAutoTitle: '拖动后回到当前维度视角',
    cameraAutoOffTitle: '关闭自动视角返回',
    locked: '已锁定',
    lock: '锁定',
    graphControls: '图形控制',
    rankTitle: '当前空间的矩阵秩',
